  ...
  return (
    <main className='flex flex-col md:px-32 md:py-16 px-6 py-8'>
      <div className='md:hidden mx-auto flex flex-col justify-center items-center '>
        ...
        <RemainingDetails variant='water' remainingAmount={water?.waterLeft ?? 0} className='w-full'></RemainingDetails>
        <ConsumeBehavior variant='water' lastHour={water?.totalLastHour ?? 0} today={water?.totalToday ?? 0} className='mt-6 mb-6 w-full'></ConsumeBehavior>
        <Control 
          variant='water' 
          isTrue={!!control}
